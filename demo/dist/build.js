 ...
 */
    ...
    __WEBPACK_IMPORTED_MODULE_0_vue__.a.use(__WEBPACK_IMPORTED_MODULE_1_plugin___default.a, {
        ...
        methods: {
            ...
            mapCreated: function($map) {
                ...
                var vm = this;
                this.map = $map, this.mapObjectManager = new ymaps.ObjectManager({
                    clusterize: !1,
                    gridSize: 60,
                ...
                }), this.map.behaviors.disable("drag"), this.map.events.add([ "click" ], function() {
                    vm.mapObjectManager.objects.balloon.close();
                }.bind(this));
                var point = {
                    type: "Feature",
                ...
                this.mapObjectManager.add(point), this.map.geoObjects.add(this.mapObjectManager);
            },
            ...
            mapCreated2: function($map) {
                ...
                this.mapObjectManager = new ymaps.ObjectManager({
                    ...
                    clusterHasBalloon: !0,
                    geoObjectOpenBalloonOnClick: !1
                }), this.mapObjectManager.add(point), $map.geoObjects.add(this.mapObjectManager);
            },
            regionChanged: function($coordinates, $polygon) {
                console.info("APP: regionChanged, coord=", $coordinates);
                var visibleID = [];
                void 0 === $polygon && ($polygon = null), this.map.behaviors.disable("drag"), this.mapObjectManager.setFilter(function(object) {
                    var in_poligon = null !== $polygon && $polygon.geometry.contains(object.geometry.coordinates), visible = null === $polygon || in_poligon;
                    return null !== $polygon && in_poligon && visibleID.push(object.id), visible;
    ...
    (function(module) {
        ...
        !function(root, factory) {
        ...
        }("undefined" != typeof self && self, function(__WEBPACK_EXTERNAL_MODULE_0__) {
            return function(modules) {
                ...
                __webpack_require__.d = function(exports, name, getter) {
                    ...
                    return Object.prototype.hasOwnProperty.call(object, property);
                }, __webpack_require__.p = "/dist/", __webpack_require__(__webpack_require__.s = 5);
            }([ function(module, exports) {
                module.exports = __WEBPACK_EXTERNAL_MODULE_0__;
            }, function(module, __webpack_exports__, __webpack_require__) {
                "use strict";
                var __WEBPACK_IMPORTED_MODULE_0__yandex_map_bus__ = __webpack_require__(2);
                ...
                "use strict";
                var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0), __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__), _typeof = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function(obj) {
                ...
                }, YandexMapBus = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
                    options: {},
                    data: function() {
                        return {
                    ...
                    methods: {
                        attachScript: function() {
                            ...
                            if (!this.scriptAttached) {
                                ...
                                "object" === _typeof(__WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions) && Object.assign(yandexMapOptions, __WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions);
                                var src = "//api-maps.yandex.ru/" + yandexMapOptions.version + "/?lang=" + yandexMapOptions.lang;
                                __WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions.apiKey.length && (src += "&apikey=" + __WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions.apiKey);
                ...
                __webpack_exports__.a = {
                    ...
                    methods: {
                        buttonClick: function(e) {
                            e.preventDefault(), e.stopPropagation(), !1 === this.selected && !1 === this.drag ? (this.initDragger(), 
                            this.$emit("status", "init")) : !1 === this.selected && !0 === this.drag ? (this.stopDragger(), 
                            this.$emit("status", "cancel")) : !0 === this.selected && (this.removeDragger(), 
                ...
                var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0), __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__), _createClass = function() {
                    ...
                    install: function(VueInstance, options) {
                        ...
                        Object.assign(opts, {
                            ...
                            lang: "ru_RU",
                            apiKey: ""
                        }, options), __WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions = opts;
                        var $yandexmap = new yandexMap(__WEBPACK_IMPORTED_MODULE_0_vue___default.a.yandexMapOptions);
                        VueInstance.prototype.$yandexmap = $yandexmap, VueInstance.component("yandex-map", __webpack_require__(6)), 
                ...
                var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_YandexMapContainer_vue__ = __webpack_require__(1), __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_834f1a84_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_YandexMapContainer_vue__ = __webpack_require__(7), __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3), Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__.a)(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_YandexMapContainer_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_834f1a84_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_YandexMapContainer_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_834f1a84_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_YandexMapContainer_vue__.b, !1, null, null, null);
                ...
                var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_RegionSelect_vue__ = __webpack_require__(4), __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b70ef2a6_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_RegionSelect_vue__ = __webpack_require__(14), __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3), __vue_styles__ = injectStyle, Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__.a)(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_RegionSelect_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b70ef2a6_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_RegionSelect_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b70ef2a6_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_RegionSelect_vue__.b, !1, __vue_styles__, null, null);
                __webpack_exports__.default = Component.exports;
            }, function(module, exports, __webpack_require__) {
                ...
                var __WEBPACK_IMPORTED_MODULE_0__listToStyles__ = __webpack_require__(13), hasDocument = "undefined" != typeof document;
    ...
    module.exports = {
        render: function() {
            ...
            return _c("div", {
            ...
            }, [ _c("h2", [ _vm._v("Map 1") ]), _vm._v("\n    zoom: 10"), _c("br"), _vm._v("\n    dragable: false"), _c("br"), _vm._v("\n    scrollZoom: false"), _c("br"), _vm._v(" "), _c("yandex-map", {
                attrs: {
                ...
                on: {
                    created: _vm.mapCreated,
                    boundschange: _vm.boundschange
                }
            }, [ _c("region-select", {
                attrs: {
                    "button-text": "Please...",
                ...
                on: {
                    changed: _vm.regionChanged
                }
            }) ], 1), _vm._v(" "), _c("br"), _vm._v(" "), _c("br"), _vm._v(" "), _c("h2", [ _vm._v("Map 2") ]), _vm._v("\n    dragable: true"), _c("br"), _vm._v("\n    scrollZoom: true"), _c("br"), _vm._v(" "), _c("button", {
                on: {
                    click: function($event) {
                        _vm.showMap = !_vm.showMap;
                    }
                }
            }, [ _vm._v(_vm._s(_vm.showMap ? "hide map" : "show map")) ]), _vm._v(" "), !0 === _vm.showMap ? _c("yandex-map", {
                attrs: {
                    zoom: 10
                },
                on: {
                    created: _vm.mapCreated2,
                    destroy: _vm.mapDestroy2,
                    boundschange: _vm.boundschange
                }
            }, [ _c("region-select", {
                attrs: {
